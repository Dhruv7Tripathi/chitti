    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-800 to-indigo-700 text-white">
      ...
      <nav className="relative z-10 px-6 py-4 flex justify-between items-center">
        ...
        <div className="space-x-6">
          ...
          <Link href="/chat" className="bg-white text-indigo-700 px-4 py-2 rounded-full font-medium hover:bg-indigo-100 transition">
            SignIn
          </Link>
        </div>
      </nav>
            ...
            <div className="max-w-md">
              ...
              {/* <div className="flex items-center text-indigo-200 text-sm">
                <div className="flex -space-x-2 mr-3">
                  {[...Array(4)].map((_, i) => (
                    <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-r from-pink-500 to-indigo-500 border-2 border-indigo-900 flex items-center justify-center text-xs font-bold">
                      {String.fromCharCode(65 + i)}
                    </div>
                  ))}
                </div>
                <span>Join 2,500+ users already chatting</span>
              </div> */}
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/10 backdrop-blur-lg p-6 rounded-3xl border border-white/20 shadow-xl">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="px-3 py-1 bg-indigo-500/30 rounded-full text-sm">
                  Tech Room
                </div>
              </div>

              <div className="space-y-4 mb-6">
                <div className="max-w-xs bg-indigo-700/50 p-3 rounded-lg rounded-tl-none">
              ...
              <div className="flex rounded-full overflow-hidden bg-white/10 border border-white/10">
                ...
                />
                <button className="bg-indigo-500 px-4">
      ...
      {/* Footer */}
      <footer className="relative z-10 bg-indigo-950 py-6 ">
        <div className="max-w-6xl mx-auto px-6">
